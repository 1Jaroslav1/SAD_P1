...
data_before_pandemic = filterByTime(general_inflation_tidy_DF, c(analysis_start, pandemic_start))
...
# during pandemic
data_during_pandemic = filterByTime(general_inflation_tidy_DF, c(pandemic_start, during_pandemic))
...
# before war
data_before_war = filterByTime(general_inflation_tidy_DF, c(during_pandemic, war_start))
...
# during war
data_during_war = filterByTime(general_inflation_tidy_DF, c(war_start, now))
