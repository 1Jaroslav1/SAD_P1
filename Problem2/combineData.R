...
draw_stacking_data(hicp, "Inflation", "Inflation (%)")
...
draw_stacking_data(avg_food_price, "Average food cost per month", "Price in $")
...
draw_stacking_data(avg_gross, "Average salary per month (full-time)", "Salary in $")
